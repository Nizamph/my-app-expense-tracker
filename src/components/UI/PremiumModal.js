...
const PremiumModal = (props) => {
 ...
 const unchangeThemeHandler = () => {
  dispatch(themeAction.unchangeTheme())
 }
...
const csvLink = {
  ...
  return (
   <div>     
        ...
        <Modal.Body>click the buttons below to enjoy the premium features</Modal.Body>
        <Modal.Footer>
         {showTheme === "none" ?<Button variant="info" className='me-auto' onClick={changeThemeHandler}>
            Change Theme
          </Button>:<Button variant="info" className='me-auto' onClick={unchangeThemeHandler}>
           Previous Theme
          </Button>}
         <Button variant="dark" className='ms-auto color-dark' >
         <CSVLink {...csvLink} >
